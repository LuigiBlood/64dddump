...
RUN cd ~ && git clone https://github.com/devwizard64/libcart.git && cd libcart && make lib/libcart_ultra.a && cp ./lib/libcart_ultra.a /usr/lib/n64/ && cp ./include/cart.h /usr/include/n64/
